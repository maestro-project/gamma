...
if __name__ == "__main__":
    ...
    if opt.fixedCluster>0:
        exp_name = "GAMMA_{}_SL-{}-{}_F1-{}_F2-{}_PE-{}_GEN-{}_POP-{}_L1-{}_L2-{}".format(opt.model_def,opt.slevel_min, opt.slevel_max,opt.fitness1, opt.fitness2, opt.num_pe, opt.epochs, opt.num_pop, opt.l1_size, opt.l2_size)
    else:
        exp_name = "GAMMA_{}_SL-{}-{}_FixCl-{}_F1-{}_F2-{}_PE-{}_GEN-{}_POP-{}_L1-{}_L2-{}".format(opt.model_def,opt.slevel_min, opt.slevel_max,opt.fixedCluster, opt.fitness1, opt.fitness2, opt.num_pe, opt.epochs, opt.num_pop, opt.l1_size, opt.l2_size)
